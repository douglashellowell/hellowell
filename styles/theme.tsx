...
import { darken, desaturate, grayscale, lighten } from 'polished';
...
export const GlobalStyle = createGlobalStyle`
  * {
  ...
  p {
    color: ${({ theme }: { theme: ThemeStyles }) => theme.fontColour800};
    line-height: 1.5;
  }
...
code:not(.hljs){
  color: ${({ theme }: { theme: ThemeStyles }) => theme.themeRed};
  background-color: ${({ theme }: { theme: ThemeStyles }) => theme.themeCream};
  padding: 5px;
  border-radius: 5px;
}
...
export type ThemeStyles = {
  ...
  secondary: string;
  fontColour: string;
  fontColour800: string;
  fontColour600: string;
  fontColour400: string;
...
const themeRed = 'hsla(359, 58%, 39%, 1)';
const themeGreyBlue = 'hsla(193, 34%, 30%, 1)';
const themeGold = 'hsla(51, 100%, 85%, 1)';
const themeCream = 'hsla(36, 72%, 56%, 1)';
const themeDarkRed = 'hsla(358, 77%, 19%, 1)';
...
const themeGenerics = {
  ...
  spacing3: '1.5rem',
  spacing4: '2rem',
  // themeRed: desaturate(0.3, 'hsl(359, 58%, 39%)'),
  // themeGreyBlue: desaturate(0.3, 'hsl(193, 34%, 30%)'),
  // themeCream: desaturate(0.3, 'hsl(51, 100%, 85%)'),
  // themeGold: desaturate(0.3, 'hsl(36, 72%, 56%)'),
  // themeDarkRed: desaturate(0.3, 'hsl(358, 77%, 19%)'),
  themeRed: 'hsl(359, 58%, 39%)',
  themeGreyBlue: 'hsl(193, 34%, 30%)',
  themeCream: 'hsl(51, 100%, 85%)',
  themeGold: 'hsl(36, 72%, 56%)',
  themeDarkRed: 'hsl(358, 77%, 19%)',
  mainWidth: '900px',
};
...
const theme: ThemeIndex = {
  [ThemeMode.lightMode]: {
    ...themeGenerics,
    fontColour800: lighten(0.2, themeGenerics.fontColour),
    fontColour600: lighten(0.4, themeGenerics.fontColour),
    fontColour400: lighten(0.6, themeGenerics.fontColour),
    secondaryCTA: lighten(0.3, themeGenerics.primaryCTA),
    linkVisited: lighten(0.2, themeGenerics.linkUnvisited),
    themeRed: themeGenerics.themeRed,
    themeGreyBlue: themeGenerics.themeGreyBlue,
    themeCream: themeGenerics.themeCream,
    themeGold: themeGenerics.themeGold,
    themeDarkRed: themeGenerics.themeDarkRed,
    codeTheme: codeThemes.lightMode,
  },
  [ThemeMode.darkMode]: {
    ...themeGenerics,
    primary: darken(0.8, themeGenerics.primary),
    secondary: darken(0.4, themeGenerics.secondary),
    fontColour: lighten(1, themeGenerics.fontColour),
    fontColour800: lighten(0.8, themeGenerics.fontColour),
    fontColour600: lighten(0.6, themeGenerics.fontColour),
    fontColour400: lighten(0.4, themeGenerics.fontColour),
    linkUnvisited: 'rgb(152, 102, 27)',
    linkVisited: lighten(0.2, 'rgb(152, 73, 27)'), // figure out a neat way to make these variables
    themeRed: darken(0.2, themeGenerics.themeRed),
    themeGreyBlue: darken(0.2, themeGenerics.themeGreyBlue),
    themeCream: darken(0.2, themeGenerics.themeCream),
    themeGold: darken(0.2, themeGenerics.themeGold),
    themeDarkRed: darken(0.2, themeGenerics.themeDarkRed),
    primaryCTA: 'red',
...
export const ThemeStateContext = React.createContext(ThemeMode.lightMode);
...
const StyledThemeProvider: React.FC = ({ children }) => {
  ...
  return (
    <ThemeToggleContext.Provider value={toggleTheme}>
      <ThemeStateContext.Provider value={selectedTheme}>
