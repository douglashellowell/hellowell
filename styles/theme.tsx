...
const theme: ThemeIndex = {
  [ThemeMode.lightMode]: {
    ...
    themeRed: themeGenerics.themeRed.replace('#', '%23'),
    themeGreyBlue: themeGenerics.themeGreyBlue.replace('#', '%23'),
    themeCream: themeGenerics.themeCream.replace('#', '%23'),
    themeGold: themeGenerics.themeGold.replace('#', '%23'),
    themeDarkRed: themeGenerics.themeDarkRed.replace('#', '%23'),
  ...
  [ThemeMode.darkMode]: {
    ...
    themeRed: darken(0.2, themeGenerics.themeRed).replace('#', '%23'),
    themeGreyBlue: darken(0.2, themeGenerics.themeGreyBlue).replace('#', '%23'),
    themeCream: darken(0.2, themeGenerics.themeCream).replace('#', '%23'),
    themeGold: darken(0.2, themeGenerics.themeGold).replace('#', '%23'),
    themeDarkRed: darken(0.2, themeGenerics.themeDarkRed).replace('#', '%23'),
    primaryCTA: 'red',
